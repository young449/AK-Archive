...
const DATA_glossary = [
  {id:311,title:"DAP (Digital Audio Player)",category:"용어사전",glossTab:"HW",models:[],date:"2026.05.18",author:"Ellie",authorInitial:"E",
...
음악 감상 전용으로 만들어진 고음질 휴대용 플레이어`,
  ...
  {id:308,title:"디바이스 (Device)",category:"용어사전",glossTab:"HW",models:[],date:"2026.05.18",author:"Ellie",authorInitial:"E",
...
집이나 사무실처럼 고정된 환경에서 사용하는 거치형 오디오 플레이어`,
  ...
  {id:315,title:"앰프 (AMP)",category:"용어사전",glossTab:"HW",models:[],date:"2026.05.26",author:"Ellie",authorInitial:"E",
...
AMP는 오디오 신호를 증폭해 기기를 안정적으로 구동하게 만드는 장치입니다.`,
  ...
  {id:307,title:"로컬 (Local)",category:"용어사전",glossTab:"Local",models:[],date:"2026.05.18",author:"Ellie",authorInitial:"E",
...
파일을 기기에 직접 넣어 재생하는 방식. 인터넷 불필요`,
  ...
  {id:306,title:"로컬 메뉴 (Local Menu)",category:"용어사전",glossTab:"Local",models:[],date:"2026.05.18",author:"Ellie",authorInitial:"E",
...
| HD 오디오 | 고음질 파일 필터 뷰 |`,
  ...
  {id:312,title:"CUE 시트 (CUE Sheet)",category:"용어사전",glossTab:"Local",models:[],date:"2026.05.18",author:"Ellie",authorInitial:"E",
...
앨범 전체를 1개 파일로 관리하면서, CUE 파일로 각 트랙을 분리·탐색할 수 있게 해주는 방식`,
   tags:["CUE Sheet","CUE 시트","메타데이터","앨범단위","트랙분리",".cue"],links:[{label:"로컬 메뉴 (Local Menu)",url:"#open:306"}]},
  {id:313,title:"CD 라이브러리 (CD Library)",category:"용어사전",glossTab:"Local",models:[],date:"2026.05.18",author:"Ellie",authorInitial:"E",
...
CD를 DAP에 디지털 파일로 옮기는 과정. 이 복사 작업을 '리핑'이라고 함`,
   tags:["CD Library","CD 라이브러리","CDRipping","CD리핑","FLAC","WAV"],links:[{label:"로컬 메뉴 (Local Menu)",url:"#open:306"}]},
  {id:310,title:"HD 오디오 (HD Audio)",category:"용어사전",glossTab:"Local",models:[],date:"2026.05.18",author:"Ellie",authorInitial:"E",
...
로컬 파일 중 고음질(HD) 파일만 모아서 보여주는 필터 뷰. 과거 명칭은 MQS`,
   tags:["HD Audio","HD 오디오","고음질","MQS"],links:[{label:"로컬 메뉴 (Local Menu)",url:"#open:306"}]},
  {id:305,title:"리모트 (Remote)",category:"용어사전",glossTab:"Service",models:[],date:"2026.05.18",author:"Ellie",authorInitial:"E",
...
기기를 앱으로 원격 조작하는 기능. 음원 저장(라이브러리)과 스트리밍(에어러블) 두 가지 방식을 지원`,
  ...
  {id:303,title:"에어러블 (airable)",category:"용어사전",glossTab:"Service",models:[],date:"2026.05.18",author:"Ellie",authorInitial:"E",
...
여러 스트리밍 서비스를 하나의 API로 묶어주는 B2B 미들웨어. 제조사가 개별 서비스와 직접 제휴·개발하는 수고를 덜어줌`,
  ...
  {id:304,title:"스트리밍 앱 (Streaming App)",category:"용어사전",glossTab:"Service",models:[],date:"2026.05.18",author:"Ellie",authorInitial:"E",
...
에어러블 미지원 서비스(Spotify 등)를 사용하기 위해 앱을 직접 설치하는 방식. 자유도는 높지만 기기 최적화는 낮을 수 있음`,
  ...
  {id:309,title:"SMB (Server Message Block)",category:"용어사전",glossTab:"Service",models:[],date:"2026.05.18",author:"Ellie",authorInitial:"E",
...
같은 와이파이 네트워크 안에서 PC·NAS 등의 폴더를 DAP에 연결해 음악을 재생하는 방식. 폴더가 안 보이면 SMB 스캔 실행`,
  ...
  {id:314,title:"이퀄라이저 (EQ)",category:"용어사전",glossTab:"Feature",models:[],date:"2026.05.26",author:"Ellie",authorInitial:"E",
...
EQ는 주파수 대역을 조절해 음악의 음색 밸런스를 바꾸는 기능. GEQ는 직관적, PEQ는 Q값까지 조절하는 고급 설정`,
  ...
  {id:301,title:"컬렉션 (Collection)",category:"용어사전",glossTab:"Feature",models:[],date:"2026.05.18",author:"Ellie",authorInitial:"E",
...
노래·앨범·아티스트·플리를 폴더별로 즐겨찾기처럼 저장하는 기능. 기존 Favorite을 SP4000T부터 확장 재정의`,
  ...
  {id:302,title:"즐겨찾기 (Favorite)",category:"용어사전",glossTab:"Feature",models:[],date:"2026.05.18",author:"Ellie",authorInitial:"E",
...
EVM → WS → ES → TP → MP 순으로 진행되는 AK 내부 하드웨어 개발 이벤트 단계`,
  ...
  {id:320,title:"AK 커넥트 (AK Connect)",category:"용어사전",glossTab:"Service",models:[],date:"2026.06.02",author:"Ellie",authorInitial:"E",
...
같은 네트워크 안에서 AK 기기끼리 음원을 공유하고 원격으로 재생을 제어하는 무선 연결 기능`,
  ...
  {id:319,title:"DAC (Digital-to-Analog Converter)",category:"용어사전",glossTab:"HW",models:[],date:"2026.06.02",author:"Ellie",authorInitial:"E",
...
디지털 음원을 아날로그 소리로 변환하는 장치. DAP 음질의 핵심 부품`,
  ...
  {id:318,title:"반드로이드 (Bandroid)",category:"용어사전",glossTab:"SW",models:[],date:"2026.06.02",author:"Ellie",authorInitial:"E",
...
Bandroid는 일반 Android보다 앱 설치가 제한된 Astell&Kern 전용 안드로이드 운영체제입니다.`,
  ...
  {id:317,title:"크로스피드 (Crossfeed)",category:"용어사전",glossTab:"Feature",models:[],date:"2026.06.02",author:"Ellie",authorInitial:"E",
