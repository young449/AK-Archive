...
function _openDetail(id, prevPage, push){
  ...
  tipBody.innerHTML=`<div class="tip-line"><span class="tip-b">*</span><span>${stageDesc}</span></div>`+
    ...
    `<a class="tip-more tip-sheet" id="tip-sheet" href="https://drive.google.com/drive/folders/141e8zYSH6cgkzDwyjyH2zl3EldqL0vOZ?usp=drive_link" target="_blank" rel="noopener">→ 상태 수정하기</a>`;
