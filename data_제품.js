...
- Manual 모드 세부 설정 항목은 개발 확인 후 추후 업데이트 예정`,
   tags:["PD5","DAC","DACMode","EnviroTune"],
   links:[
     {label:"UX 시나리오 — Figma", url:"https://www.figma.com/design/pat4EALAOO9XW7Hynp30Md/UX_Crimson_F_U?node-id=9368-9568&t=u6hSItbuRJmIQMIS-1"},
     {label:"UI — Figma", url:"https://www.figma.com/design/iURsNWDWbdEOvnjSZzq3vj/UI_Crimson_F_U?node-id=10316-25448&t=3ye5vBYrOr6nuDXZ-1"},
   ],
   images:[
  ...
  {id:25,title:"PD20 — PD series 최신 모델",category:"제품 모델",models:["PD series"],date:"2026.05.21",author:"Luna",authorInitial:"L",
